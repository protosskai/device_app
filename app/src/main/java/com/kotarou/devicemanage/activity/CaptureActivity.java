...
import com.kotarou.devicemanage.common.camera.CameraManager;
import com.kotarou.devicemanage.common.camera.CameraPreview;
...
public class CaptureActivity extends Activity {
    ...
    private void addEvents() {
        scanRestart.setOnClickListener(v -> {
            if (barcodeScanned) {
